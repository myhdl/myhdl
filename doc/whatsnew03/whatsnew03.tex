...
the \code{ always @* } construct, that infers all input signals. The
SystemVerilog 3.1 standard attemps to further improve on this by
introducting the \code{always_comb} block with slightly enhanced
semantics.
