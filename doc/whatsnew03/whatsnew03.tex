...
In the waveform in Section~\ref{section-wave}, you see a
\class{Signal} called \code{state} which as been constructed with an
...
rather limited - the main difference is that logical results will
