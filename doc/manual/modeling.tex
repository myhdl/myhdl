...
\begin{quote}
\em 
High level modeling is the true vocation of \myhdl{}.
The possibilities are vast. 
This section should be seen as a starting point for experiments
and exploration. Over time, more techniques that prove useful will
be added.
\end{quote}
