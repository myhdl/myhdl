...
The basename of the VCD output filename is \code{func.func_name}
by default.
...
The \code{@always_comb} decorator infers the inputs of the combinatorial
...
The basename of the Verilog output filename is \code{func.func_name}
by default.
