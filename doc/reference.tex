...
\item[(2)] In contrast to standard Python sequencing conventions,
	  ...
	  indexing convention, combined with the classical convention
	  that the most significant digits of a number are the
	  leftmost ones.  However, the Python convention of half-open
	  ranges is followed: the bit with the highest index is not
